...
[Windows.UI.Notifications.ToastNotificationManager]::CreateToastNotifier('DockedTools').Show($toast)
";
        ...
        private void RestartApplication()
        {
            try
            {
                ...
                Process.Start(currentProcess.MainModule?.FileName ?? "DockedTools.exe");
