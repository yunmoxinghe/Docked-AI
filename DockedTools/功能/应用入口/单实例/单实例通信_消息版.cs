...
namespace DockedTools.Features.AppEntry.SingleInstance
{
    /// <summary>
    ...
    {
        // 注册全局唯一的 Windows 消息
        private static readonly uint WM_SHOW_DockedTools;
        ...
        {
            WM_SHOW_DockedTools = RegisterWindowMessage("WM_SHOW_DockedTools_WINDOW");
            System.Diagnostics.Debug.WriteLine($"[SingleInstanceCommunicationMessage] Registered message ID: 0x{WM_SHOW_DockedTools:X}");
        }
        ...
        public static void NotifyShowWindow()
        {
            ...
            {
                // 广播消息到所有顶级窗口
                bool success = PostMessage(HWND_BROADCAST, WM_SHOW_DockedTools, IntPtr.Zero, IntPtr.Zero);
