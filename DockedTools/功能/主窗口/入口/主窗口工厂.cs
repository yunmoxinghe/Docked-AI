...
namespace DockedTools.Features.MainWindow.Entry
{
    /// <summary>
    ...
    public static class MainWindowFactory
    {
        ...
        public static global::DockedTools.MainWindow CreateAndActivate()
        {
            var window = new global::DockedTools.MainWindow();
        ...
        /// </summary>
        /// <returns>新创建的主窗口实例</returns>
        public static global::DockedTools.MainWindow Create()
        {
            return new global::DockedTools.MainWindow();
        }
        ...
        public static global::DockedTools.MainWindow GetOrCreate(Window? existingWindow)
        {
            if (IsWindowValid(existingWindow))
            {
                return (global::DockedTools.MainWindow)existingWindow!;
            }
